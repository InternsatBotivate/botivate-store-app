...
async function onSubmit(data: z.infer<typeof schema>) {
  try {
    ...
    const getNextIndentNumber = (existingIndents: Partial<IndentSheet>[]) => {
      if (!Array.isArray(existingIndents) || existingIndents.length === 0) return "SI-0001";

      // Get all available indent numbers (only existing rows in sheet)
      const availableNumbers = existingIndents
        .filter(indent => indent.indentNumber && typeof indent.indentNumber === "string")
                                                            ...
                                                            <SelectContent>
                                                                ...
                                                                <div className="flex items-center border-b px-3 pb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        onKeyDown={(e) => e.stopPropagation()} // ✅ Prevent 1-letter freeze
                                                            ...
                                                            <SelectContent>
                                                                ...
                                                                <div className="flex items-center border-b px-3 pb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        onKeyDown={(e) => e.stopPropagation()} // ✅ Freeze fix
                                                                        className="flex h-10 w-full rounded-md border-0 bg-transparent py-3 text-sm outline-none placeholder:text-muted-foreground"
                                                                    />
                                                                </div>
